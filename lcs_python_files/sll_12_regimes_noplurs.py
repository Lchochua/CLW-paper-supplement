...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 22 15:22:49 2023
...
nmax = 12  # 0 = MFN, 1 = CU(12), 2 = CU(23), 3 = CU(31), 4 = CU(123), 5 = FTA(12), 6 = FTA(23), 7 = FTA(31),
# 8 = FTA(12,31), 9 = FTA(12,23), 10 = FTA(23,31), 11 = FTA(123)

n = 25 # Choose the number of firms in the differentiated sector
...
def Network(nmax, S):
    ...
    A[1] = np.matrix(A[1]+[z,I[0],z,I[0],I[2],I[0],z,I[0],I[0]+I[5]+I[7],I[6],I[6],I[6]+I[9]+I[10]])
    A[2] = np.matrix(A[2]+[z,I[0],I[0],z,I[3],I[0],I[0],z,I[7],I[0]+I[5]+I[6],I[7],I[7]+I[8]+I[10]])
    A[3] = np.matrix(A[3]+[z,z,I[0],I[0],I[1],z,I[0],I[0],I[5],I[5],I[0]+I[6]+I[7],I[5]+I[8]+I[9]])
    A[4] = np.matrix(A[4]+[I[1]+I[5],I[0]+I[5],I[0]+I[1]+I[5],I[0]+I[1]+I[5],I[0]+I[1]+I[2]+I[3]+I[5],I[0]+I[1],I[0]+I[1]+I[5]+I[9],I[0]+I[1]+I[5]+I[8],I[0]+I[1]+I[5]+I[7],I[0]+I[1]+I[5]+I[6],I[0]+I[1]+I[5]+I[6]+I[7]+I[8]+I[9]+I[11],I[0]+I[1]+I[5]+I[6]+I[7]+I[8]+I[9]+I[10]])
    A[5] = np.matrix(A[5]+[I[2]+I[6],I[0]+I[2]+I[6],I[0]+I[6],I[0]+I[2]+I[6],I[0]+I[1]+I[2]+I[3]+I[6],I[0]+I[2]+I[6]+I[9],I[0]+I[2],I[0]+I[2]+I[6]+I[10],I[0]+I[2]+I[5]+I[6]+I[7]+I[9]+I[10]+I[11],I[0]+I[2]+I[5]+I[6],I[0]+I[2]+I[6]+I[7],I[0]+I[2]+I[5]+I[6]+I[7]+I[8]+I[9]+I[10]])
    A[6] = np.matrix(A[6]+[I[3]+I[7],I[0]+I[3]+I[7],I[0]+I[3]+I[7],I[0]+I[7],I[0]+I[1]+I[2]+I[3]+I[7],I[0]+I[3]+I[7]+I[8],I[0]+I[3]+I[7]+I[10],I[0]+I[3],I[0]+I[3]+I[5]+I[7],I[0]+I[3]+I[5]+I[6]+I[7]+I[8]+I[10]+I[11],I[0]+I[3]+I[6]+I[7],I[0]+I[3]+I[5]+I[6]+I[7]+I[8]+I[9]+I[10]])
    return A
...
def main():
    ...
    df.to_excel(f'sll_stable_sets_12_regimes_full_{n}.xlsx', index=False)
    print('The End')
