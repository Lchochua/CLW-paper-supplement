...
def Pref(P,S,X,k,m,n):
    ...
    for p in P:
        ...
        entry = 1
        if p == 0:
            Util[pme][entry] = matrices_dict[f"CUI_{n}"][k,m] + matrices_dict["Tr_CUI"][k,m]
        elif p == 1:
            Util[pme][entry] = matrices_dict[f"CUI_{n}"][k,m] + matrices_dict["Tr_CUI"][k,m]
        else:
            Util[pme][entry] = matrices_dict[f"CUO_{n}"][k,m] + matrices_dict["Tr_CUO"][k,m]
        ...
        entry = 5
        if p == 0:
            Util[pme][entry] = matrices_dict[f"FTAI_{n}"][k,m] + matrices_dict["Tr_FTAI"][k,m]
        elif p == 1:
            Util[pme][entry] = matrices_dict[f"FTAI_{n}"][k,m] + matrices_dict["Tr_FTAI"][k,m]
        else:
            Util[pme][entry] = matrices_dict[f"FTAO_{n}"][k,m] + matrices_dict["Tr_FTAO"][k,m]
        ...
        entry = 8
        if p == 0:
            Util[pme][entry] = matrices_dict[f"HUB_{n}"][k,m] + matrices_dict["Tr_HUB"][k,m]
        elif p == 1:
            Util[pme][entry] = matrices_dict[f"SPOKE_{n}"][k,m] + matrices_dict["Tr_SPOKE"][k,m]
        else:
            Util[pme][entry] = matrices_dict[f"SPOKE_{n}"][k,m] + matrices_dict["Tr_SPOKE"][k,m]
...
def main():
    ...
    df.to_excel(f'sym_stable_sets_12_regimes_full_{n}.xlsx', index=False)
    print('The End')
